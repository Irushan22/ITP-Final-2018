...
public class transport extends javax.swing.JFrame {
    ...
    public void tableload(){
         try {
             String sql = "SELECT tid,tyear,tmonth,tprice FROM transport";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/akitha_interfaces/images/icons8-truck-24.png"))); // NOI18N
    ...
    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        ...
        if(x==0){
            try {
                ...
                String sql = "DELETE from transport where tid='"+id+"'";
                pst = con.prepareStatement(sql);
                pst.execute();
                tableload();
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if(x==0){
            ...
            try {
             String sql1 = "select tyear from transport where tmonth = '"+mont+"' && tyear = '"+yea+"'";
            pst = con.prepareStatement(sql1);
            rs = pst.executeQuery();
            rs.next();
            String add = rs.getString("tyear");
            if(yea.equals(add))
            ...
            try {
                String sql = "UPDATE transport SET tyear = '"+yea+"',tmonth='"+mont+"',tprice='"+pric+"'where tid='"+id+"'";
                pst = con.prepareStatement(sql);
                pst.execute();
                tableload();
            } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "select * from transport where tmonth LIKE '%"+month+"%' && tyear = '"+year+"'";
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
      ...
      try {
             String sql1 = "select tyear from transport where tmonth = '"+mn+"' && tyear = '"+yr+"'";
            pst = con.prepareStatement(sql1);
            rs = pst.executeQuery();
            rs.next();
            String add = rs.getString("tyear");
        ...
        try {
            String q = "INSERT INTO transport (tyear,tmonth,tprice) values ('"+yr+"','"+mn+"','"+pr+"')";
