...
Connection con = null;
    ...
    public void tableload(){
        try {
             String sql = "SELECT id,year,month,price FROM salary1";
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/akitha_interfaces/images/icons8-cash-in-hand-48.png"))); // NOI18N
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
      ...
      try {
             String sql1 = "select year from salary1 where month = '"+mn+"' && year = '"+yr+"'";
        ...
        try {
            String q = "INSERT INTO salary1 (year,month,price) values ('"+yr+"','"+mn+"','"+pr+"')";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
       ...
       if(x==0){
           ...
           try {
             String sql1 = "select year from salary1 where month = '"+mont+"' && year = '"+yea+"'";
            pst = con.prepareStatement(sql1);
            rs = pst.executeQuery();
            rs.next();
            String add = rs.getString("year");
           ...
           try {
               String sql = "UPDATE salary1 SET year = '"+yea+"',month='"+mont+"',price='"+pric+"'where id='"+id+"'";
           pst = con.prepareStatement(sql);
           pst.execute();
           tableload();
           } catch (Exception e) {
    ...
    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        ...
        if(x==0){
            try {
                String id = sid.getText();
                String sql = "DELETE from salary1 where id='"+id+"'";
                pst = con.prepareStatement(sql);
                pst.execute();
                tableload();
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
      int key5=evt.getKeyCode();
...

        {
            ...
            jLabel7.setText("* Please insert only NUMBERS");
            getToolkit().beep();
        }
